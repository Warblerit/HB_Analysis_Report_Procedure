...
GO
IF EXISTS (SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[dbo].[SP_HBAnalysis_Apr2018]') AND OBJECTPROPERTY(ID, N'ISPROCEDURE') = 1)
DROP PROCEDURE [dbo].[SP_HBAnalysis_Apr2018]
GO 
CREATE PROCEDURE [dbo].[SP_HBAnalysis_Apr2018](@Action NVARCHAR(100),@Str NVARCHAR(100),@Id BIGINT)
--Exec [dbo].[SP_HBAnalysis_Apr2018] @Action = '',@Str = '',@Id = 0;
AS
BEGIN
SET NOCOUNT ON
...
SELECT '' AS C1,
'Apr-18' AS C22, 
'Mar-18' AS C3, 'Feb-18' AS C4, 'Jan-18' AS C5, 'Dec-17' AS C6, 'Nov-17' AS C7, 'Oct-17' AS C8, 'Sep-17' AS C9, 
'Aug-17' AS C10, 'Jul-17' AS C11, 'Jun-17' AS C12, 'May-17' AS C13, 'Apr-17' AS C14;
...
'Apr-2018' AS C22, 
'Total' AS Total,
'Mar-18' AS C3, 'Feb-18' AS C4, 'Jan-18' AS C5, 'Dec-17' AS C6, 'Nov-17' AS C7, 'Oct-17' AS C8, 'Sep-17' AS C9, 'Aug-17' AS C10, 'Jul-17' AS C11, 'Jun-17' AS C12, 
'May-17' AS C13, 'Apr-17' AS C14;
