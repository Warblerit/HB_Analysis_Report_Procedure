...
GO
IF EXISTS (SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[dbo].[SP_HBAnalysis_Jan2019]') AND OBJECTPROPERTY(ID, N'ISPROCEDURE') = 1)
DROP PROCEDURE [dbo].[SP_HBAnalysis_Jan2019]
GO 
CREATE PROCEDURE [dbo].[SP_HBAnalysis_Jan2019](@Action NVARCHAR(100),@Str NVARCHAR(100),@Id BIGINT)
--Exec [dbo].[SP_HBAnalysis_Jan2019] @Action = '',@Str = '',@Id = 0;
AS
BEGIN
SET NOCOUNT ON
...
'Apr-2018', 'May-2018', 'Jun-2018', 'Jul-2018', 'Aug-2018', 'Sep-2018', 'Oct-2018', 'Nov-2018', 'Dec-2018', 'Jan-2019');
...
SELECT '' AS C1,
'Jan-19' AS C24, 'Dec-18' AS C23, 'Nov-18' AS C22, 'Oct-18' AS C21, 'Sep-18' AS C2, 'Aug-18' AS C3, 'Jul-18' AS C4, 'Jun-18' AS C5, 'May-18' AS C6, 'Apr-18' AS C7,
'Mar-18' AS C8, 'Feb-18' AS C9, 'Jan-18' AS C10, 'Dec-17' AS C11, 'Nov-17' AS C12, 'Oct-17' AS C13, 'Sep-17' AS C14, 
'Aug-17' AS C15, 'Jul-17' AS C16, 'Jun-17' AS C17, 'May-17' AS C18, 'Apr-17' AS C19;
...
[Jan-2019], [Dec-2018], [Nov-2018], [Oct-2018], [Sep-2018], [Aug-2018], [Jul-2018], [Jun-2018], [May-2018], [Apr-2018],
[Mar-2018], [Feb-2018], [Jan-2018], [Dec-2017], [Nov-2017], [Oct-2017], [Sep-2017], [Aug-2017], [Jul-2017], [Jun-2017], [May-2017], [Apr-2017]
FROM #TDR T
ORDER BY Flg ASC, [Jan-2019] DESC, MasterPropertyName ASC;
-- TABLE 3 & 4
...
[Mar-2018], [Feb-2018], [Jan-2018], [Dec-2017], [Nov-2017], [Oct-2017], [Sep-2017], [Aug-2017], [Jul-2017], [Jun-2017], [May-2017], [Apr-2017]
FROM #TDRClient T
ORDER BY Flg ASC, [Jan-2019] DESC, MasterClientName ASC;
-- TABLE 5 & 6
...
[Mar-2018], [Feb-2018], [Jan-2018], [Dec-2017], [Nov-2017], [Oct-2017], [Sep-2017], [Aug-2017], [Jul-2017], [Jun-2017], [May-2017], [Apr-2017]
FROM #GTVTOTALCLIENT
ORDER BY MarkupFlg ASC, [Jan-2019] DESC, MasterClientName ASC;
...
---
SELECT [Apr-2017], [May-2017], [Jun-2017], [Jul-2017], [Aug-2017], [Sep-2017], [Oct-2017], [Nov-2017], [Dec-2017], [Jan-2018], [Feb-2018], [Mar-2018],
	   [Apr-2018], [May-2018], [Jun-2018], [Jul-2018], [Aug-2018], [Sep-2018], [Oct-2018], [Nov-2018], [Dec-2018], [Jan-2019], [Feb-2019], [Mar-2019]
INTO #TEMPMONTH3
FROM #TEMPMONTH2
PIVOT
...
SUM([Apr-2017]), SUM([May-2017]), SUM([Jun-2017]), SUM([Jul-2017]), 
SUM([Aug-2017]), SUM([Sep-2017]), SUM([Oct-2017]), SUM([Nov-2017]), 
SUM([Dec-2017]), SUM([Jan-2018]), SUM([Feb-2018]), SUM([Mar-2018]),

SUM([Apr-2018]), SUM([May-2018]), SUM([Jun-2018]), SUM([Jul-2018]), 
SUM([Aug-2018]), SUM([Sep-2018]), SUM([Oct-2018]), SUM([Nov-2018]), 
...
SUM([Apr-2017]), SUM([May-2017]), SUM([Jun-2017]), SUM([Jul-2017]), SUM([Aug-2017]), SUM([Sep-2017]), SUM([Oct-2017]), SUM([Nov-2017]),
SUM([Dec-2017]), SUM([Jan-2018]), SUM([Feb-2018]), SUM([Mar-2018]), SUM([Apr-2018]), SUM([May-2018]), SUM([Jun-2018]), SUM([Jul-2018]), 
SUM([Aug-2018]), SUM([Sep-2018]), SUM([Oct-2018]), SUM([Nov-2018]), SUM([Dec-2018]), SUM([Jan-2019]), SUM([Feb-2019]), SUM([Mar-2019])
FROM #TEMPMONTH16 T
LEFT OUTER JOIN WRBHBMasterClientManagement M WITH(NOLOCK)ON T.MasterClientId = M.Id
WHERE Markup = 0 AND T.MasterClientId NOT IN (SELECT MasterClientId FROM HBAnalysis_ClientList WHERE Active = 1)
ORDER BY SUM([Jan-2019]) DESC;

CREATE TABLE #TEMPMONTH116_Tot([Apr-2017] INT, [May-2017] INT, [Jun-2017] INT, [Jul-2017] INT, [Aug-2017] INT, [Sep-2017] INT, [Oct-2017] INT, [Nov-2017] INT, [Dec-2017] INT,
[Jan-2018] INT, [Feb-2018] INT, [Mar-2018] INT,[Apr-2018] INT, [May-2018] INT, [Jun-2018] INT, [Jul-2018] INT, [Aug-2018] INT, [Sep-2018] INT, [Oct-2018] INT, [Nov-2018] INT,
[Dec-2018] INT, [Jan-2019] INT, [Feb-2019] INT, [Mar-2019] INT, Flg INT);

INSERT INTO #TEMPMONTH116_Tot
SELECT SUM([Apr-2017]), SUM([May-2017]), SUM([Jun-2017]), SUM([Jul-2017]), SUM([Aug-2017]), SUM([Sep-2017]), SUM([Oct-2017]), SUM([Nov-2017]),
SUM([Dec-2017]), SUM([Jan-2018]), SUM([Feb-2018]), SUM([Mar-2018]), SUM([Apr-2018]), SUM([May-2018]), SUM([Jun-2018]), SUM([Jul-2018]), 
SUM([Aug-2018]), SUM([Sep-2018]), SUM([Oct-2018]), SUM([Nov-2018]), SUM([Dec-2018]), SUM([Jan-2019]), SUM([Feb-2019]), SUM([Mar-2019]), 0 FROM #TEMPMONTH16;
-- Result

SELECT '' AS C1,
'Jan-19' AS C28, 'Dec-18' AS C27, 'Nov-18' AS C26, 'Oct-18' AS C26, 'Sep-18' AS C25, 'Aug-18' AS C24, 'Jul-18' AS C23, 'Jun-18' AS C22, 'May-18' AS C2, 'Apr-18' AS C3,
'Tot(2017)-Avg' AS Total,
...
SELECT '', Title,
[Jan-2019], [Dec-2018], [Nov-2018], [Oct-2018], [Sep-2018], [Aug-2018], [Jul-2018], [Jun-2018], [May-2018], [Apr-2018],
CAST(ROUND(CAST([Mar-2018] + [Feb-2018] + [Jan-2018] + [Dec-2017] + [Nov-2017] + [Oct-2017] + [Sep-2017] + [Aug-2017] + [Jul-2017] + [Jun-2017] + [May-2017] + [Apr-2017] AS DECIMAL) / 12, 0) AS INT) AS Total,
[Mar-2018], [Feb-2018], [Jan-2018], [Dec-2017], [Nov-2017], [Oct-2017], [Sep-2017], [Aug-2017], [Jul-2017], [Jun-2017], [May-2017], [Apr-2017]
FROM #TEMPMONTH4 
...
CAST(ROUND((CAST((T1.[Apr-2017] + T1.[May-2017] + T1.[Jun-2017] + T1.[Jul-2017] + T1.[Aug-2017] + T1.[Sep-2017] + T1.[Oct-2017] + T1.[Nov-2017] + T1.[Dec-2017] + T1.[Jan-2018] + 
T1.[Feb-2018] + T1.[Mar-2018]) AS DECIMAL) / 
(T2.[Apr-2017] + T2.[May-2017] + T2.[Jun-2017] + T2.[Jul-2017] + T2.[Aug-2017] + T2.[Sep-2017] + T2.[Oct-2017] + T2.[Nov-2017] + T2.[Dec-2017] + T2.[Jan-2018] + T2.[Feb-2018] + 
T2.[Mar-2018])) * 100, 0) AS INT) AS Total,
CAST(ROUND(((T1.[Mar-2018]) / T2.[Mar-2018]) * 100, 0) AS INT) AS [Mar-2018],
CAST(ROUND(((T1.[Feb-2018]) / T2.[Feb-2018]) * 100, 0) AS INT) AS [Feb-2018],
CAST(ROUND(((T1.[Jan-2018]) / T2.[Jan-2018]) * 100, 0) AS INT) AS [Jan-2018],
CAST(ROUND(((T1.[Dec-2017]) / T2.[Dec-2017]) * 100, 0) AS INT) AS [Dec-2017],
CAST(ROUND(((T1.[Nov-2017]) / T2.[Nov-2017]) * 100, 0) AS INT) AS [Nov-2017],
CAST(ROUND(((T1.[Oct-2017]) / T2.[Oct-2017]) * 100, 0) AS INT) AS [Oct-2017],
CAST(ROUND(((T1.[Sep-2017]) / T2.[Sep-2017]) * 100, 0) AS INT) AS [Sep-2017],
CAST(ROUND(((T1.[Aug-2017]) / T2.[Aug-2017]) * 100, 0) AS INT) AS [Aug-2017],
CAST(ROUND(((T1.[Jul-2017]) / T2.[Jul-2017]) * 100, 0) AS INT) AS [Jul-2017],
CAST(ROUND(((T1.[Jun-2017]) / T2.[Jun-2017]) * 100, 0) AS INT) AS [Jun-2017],
CAST(ROUND(((T1.[May-2017]) / T2.[May-2017]) * 100, 0) AS INT) AS [May-2017],
CAST(ROUND(((T1.[Apr-2017]) / T2.[Apr-2017]) * 100, 0) AS INT) AS [Apr-2017]
...
WHERE T.BookedDt IN ('Apr-2017', 'May-2017', 'Jun-2017', 'Jul-2017', 'Aug-2017', 'Sep-2017', 'Oct-2017', 'Nov-2017', 'Dec-2017', 'Jan-2018', 'Feb-2018', 'Mar-2018',
'Apr-2018', 'May-2018', 'Jun-2018', 'Jul-2018', 'Aug-2018', 'Sep-2018', 'Oct-2018', 'Nov-2018', 'Dec-2018', 'Jan-2019')
...
WHERE T.MasterClientId IN (SELECT MasterClientId FROM HBAnalysis_ClientList WHERE Active = 1)
GROUP BY T.MasterClientId, M.ClientName
ORDER BY SUM(ISNULL([Jan-2019],0)) DESC;
--
INSERT INTO #Temp_BookingCnt
...
WHERE T.MasterClientId NOT IN (SELECT MasterClientId FROM HBAnalysis_ClientList WHERE Active = 1);
--
SELECT '' AS Title1, MasterClientName AS Title2,
[Jan-2019], [Dec-2018], [Nov-2018], [Oct-2018], [Sep-2018], [Aug-2018], [Jul-2018], [Jun-2018], [May-2018], [Apr-2018],
CAST(ROUND(CAST([Mar-2018] + [Feb-2018] + [Jan-2018] + [Dec-2017] + [Nov-2017] + [Oct-2017] + [Sep-2017] + [Aug-2017] + [Jul-2017] + [Jun-2017] + [May-2017] + [Apr-2017] AS DECIMAL) / 12, 0) AS INT) AS Total,
[Mar-2018], [Feb-2018], [Jan-2018], [Dec-2017], [Nov-2017], [Oct-2017], [Sep-2017], [Aug-2017], [Jul-2017], [Jun-2017], [May-2017], [Apr-2017]
