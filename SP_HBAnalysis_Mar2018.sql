...
GO
IF EXISTS (SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[dbo].[SP_HBAnalysis_Mar2018]') AND OBJECTPROPERTY(ID, N'ISPROCEDURE') = 1)
DROP PROCEDURE [dbo].[SP_HBAnalysis_Mar2018]
GO 
CREATE PROCEDURE [dbo].[SP_HBAnalysis_Mar2018](@Action NVARCHAR(100),@Str NVARCHAR(100),@Id BIGINT)
--Exec [dbo].[SP_HBAnalysis_Mar2018] @Action = '',@Str = '',@Id = 0;
AS
BEGIN
SET NOCOUNT ON
...
SELECT '' AS C1, 
'Mar-18' AS C2, 'Feb-18' AS C3, 'Jan-18' AS C4, 'Dec-17' AS C5, 'Nov-17' AS C6, 'Oct-17' AS C7, 'Sep-17' AS C8, 'Aug-17' AS C9, 'Jul-17' AS C10, 'Jun-17' AS C11, 
'May-17' AS C12, 'Apr-17' AS C13, 
'Mar-17' AS C14, 'Feb-17' AS C15, 'Jan-17' AS C16, 'Dec-16' AS C17, 'Nov-16' AS C18, 'Oct-16' AS C19, 'Sep-16' AS C20, 'Aug-16' AS C21, 'Jul-16' AS C22, 'Jun-16' AS C23, 
'May-16' AS C24, 'Apr-16' AS C25;
...
'May-17' AS C12, 'Apr-17' AS C13,
'Total' AS Total, 
'Mar-17' AS C14, 'Feb-17' AS C15, 'Jan-17' AS C16, 'Dec-16' AS C17, 'Nov-16' AS C18, 'Oct-16' AS C19, 'Sep-16' AS C20, 'Aug-16' AS C21, 'Jul-16' AS C22, 
'Jun-16' AS C23, 'May-16' AS C24, 'Apr-16' AS C25;
