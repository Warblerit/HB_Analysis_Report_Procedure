...
GO
IF EXISTS (SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[dbo].[SP_HBAnalysis_Aug2018]') AND OBJECTPROPERTY(ID, N'ISPROCEDURE') = 1)
DROP PROCEDURE [dbo].[SP_HBAnalysis_Aug2018]
GO 
CREATE PROCEDURE [dbo].[SP_HBAnalysis_Aug2018](@Action NVARCHAR(100),@Str NVARCHAR(100),@Id BIGINT)
--Exec [dbo].[SP_HBAnalysis_Aug2018] @Action = '',@Str = '',@Id = 0;
AS
BEGIN
SET NOCOUNT ON
...
SELECT '' AS C1,
'Aug-18' AS C23, 'Jul-18' AS C23, 'Jun-18' AS C22, 'May-18' AS C2, 'Apr-18' AS C3,
...
FROM #TDR T
ORDER BY Flg ASC, [Aug-2018] DESC, MasterPropertyName ASC;
-- TABLE 3 & 4
...
[Mar-2018], [Feb-2018], [Jan-2018], [Dec-2017], [Nov-2017], [Oct-2017], [Sep-2017], [Aug-2017], [Jul-2017], [Jun-2017], [May-2017], [Apr-2017]
FROM #TDRClient T
ORDER BY Flg ASC, [Aug-2018] DESC, MasterClientName ASC;
-- TABLE 5 & 6
SELECT 'Room Nights by Property Category ( Value in Nos )' AS Title;
...
[Mar-2018], [Feb-2018], [Jan-2018], [Dec-2017], [Nov-2017], [Oct-2017], [Sep-2017], [Aug-2017], [Jul-2017], [Jun-2017], [May-2017], [Apr-2017]
FROM #GTVTOTALCLIENT
ORDER BY MarkupFlg ASC, [Aug-2018] DESC, MasterClientName ASC;
...
SELECT '' AS C1,
'Aug-2018' AS C24, 'Jul-2018' AS C23, 'Jun-2018' AS C22, 'May-2018' AS C2, 'Apr-2018' AS C3,
'Total' AS Total,
