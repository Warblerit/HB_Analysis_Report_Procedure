...
GO
IF EXISTS (SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[dbo].[SP_HBAnalysis_Jan2020]') AND OBJECTPROPERTY(ID, N'ISPROCEDURE') = 1)
DROP PROCEDURE [dbo].[SP_HBAnalysis_Jan2020]
GO 
CREATE PROCEDURE [dbo].[SP_HBAnalysis_Jan2020](@Action NVARCHAR(100),@Str NVARCHAR(100),@Id BIGINT)
/*
Exec [dbo].[SP_HBAnalysis_Jan2020] @Action = '',@Str = '',@Id = 0;
*/
AS
BEGIN
SET NOCOUNT ON
...
FROM #TDR T
ORDER BY Flg ASC, [Jan-2020] DESC, MasterPropertyName ASC;
...
[Mar-2019], [Feb-2019], [Jan-2019], [Dec-2018], [Nov-2018], [Oct-2018], [Sep-2018], [Aug-2018], [Jul-2018], [Jun-2018], [May-2018], [Apr-2018]
FROM #TDRClient T
ORDER BY Flg ASC, [Jan-2020] DESC, MasterClientName ASC;
...
[Mar-2019], [Feb-2019], [Jan-2019], [Dec-2018], [Nov-2018], [Oct-2018], [Sep-2018], [Aug-2018], [Jul-2018], [Jun-2018], [May-2018], [Apr-2018]
FROM #GTVTOTALCLIENT
ORDER BY MarkupFlg ASC, [Jan-2020] DESC, MasterClientName ASC;
...
SELECT '' AS C1,
'Jan-20' AS C22, 'Dec-19' AS C22, 'Nov-19' AS C21, 'Oct-19' AS C20, 'Sep-19' AS C19, 'Aug-19' AS C18, 'Jul-19' AS C17, 'Jun-19' AS C16, 'May-19' AS C15, 'Apr-19' AS C14,
