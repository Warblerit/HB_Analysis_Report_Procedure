...
GO
IF EXISTS (SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[dbo].[SP_HBAnalysis_Feb2018]') AND OBJECTPROPERTY(ID, N'ISPROCEDURE') = 1)
DROP PROCEDURE [dbo].[SP_HBAnalysis_Feb2018]
GO 
CREATE PROCEDURE [dbo].[SP_HBAnalysis_Feb2018](@Action NVARCHAR(100),@Str NVARCHAR(100),@Id BIGINT)
--Exec [dbo].[SP_HBAnalysis_Feb2018] @Action = '',@Str = '',@Id = 0;
AS
BEGIN
SET NOCOUNT ON
...
--SELECT SUM([Apr-2016]), SUM([Apr-2017]) FROM #TEMPDAILYREPORTCOUNT WHERE PropertyCategory IN ('External','C P P') AND MasterPropertyId NOT IN (1,0);
...
WHERE T.MasterClientId IN (SELECT MasterClientId FROM HBAnalysis_ClientList) AND PropertyCategory IN ('External','C P P')
...
SUM([Jan-2019]), SUM([Feb-2019]), SUM([Mar-2019])
FROM #TEMPDAILYREPORTCOUNT T
WHERE T.MasterClientId NOT IN (SELECT MasterClientId FROM HBAnalysis_ClientList) AND PropertyCategory IN ('External','C P P');
--
INSERT INTO #TDRClient
SELECT 'Total', 0, 3,
SUM([Apr-2014]), SUM([May-2014]), SUM([Jun-2014]), SUM([Jul-2014]), SUM([Aug-2014]), SUM([Sep-2014]), SUM([Oct-2014]), SUM([Nov-2014]), SUM([Dec-2014]), 
...
--SELECT SUM([Apr-2016]), SUM([Apr-2017]) FROM #TEMPDAILYREPORTCOUNT;
...
--SELECT PropertyCategory, SUM([Jun-2016]), SUM([Jun-2017]) FROM #TEMPMARKUP GROUP BY PropertyCategory;RETURN;
...
WHERE T.MasterClientId IN (SELECT MasterClientId FROM HBAnalysis_ClientList)
GROUP BY C.ClientName, T.MasterClientId;
--
INSERT INTO #TDRMARKUP
SELECT 'Other Clients', 0, 2,
...
SUM([Jan-2019]), SUM([Feb-2019]), SUM([Mar-2019]) 
FROM #TEMPMARKUP T
WHERE T.MasterClientId NOT IN (SELECT MasterClientId FROM HBAnalysis_ClientList);
--
...
ROUND(SUM([Dec-2018]) * 0.00001, 2), ROUND(SUM([Jan-2019]) * 0.00001, 2), ROUND(SUM([Feb-2019]) * 0.00001, 2), ROUND(SUM([Mar-2019]) * 0.00001, 2)
FROM #TEMPGTVwithMARKUP
WHERE MasterClientId NOT IN (SELECT MasterClientId FROM HBAnalysis_ClientList);
--
INSERT INTO #GTVTOTALCLIENT
...
SELECT '' AS C1, 
'Feb-18' AS C2, 'Jan-18' AS C3, 'Dec-17' AS C4, 'Nov-17' AS C5, 'Oct-17' AS C6, 'Sep-17' AS C7, 'Aug-17' AS C8, 'Jul-17' AS C9, 
'Jun-17' AS C10, 'May-17' AS C11, 'Apr-17' AS C12, 
'Mar-17' AS C13, 'Feb-17' AS C14, 'Jan-17' AS C15, 'Dec-16' AS C16, 'Nov-16' AS C17, 'Oct-16' AS C18, 'Sep-16' AS C19, 'Aug-16' AS C20, 'Jul-16' AS C21, 
'Jun-16' AS C22, 'May-16' AS C23, 'Apr-16' AS C24;

-- TABLE 1 & 2
SELECT 'Property ( Hotel Chain ) - Room Nights ( Value in Nos )' AS Title;
SELECT 'PropertyName' AS C1;
SELECT MasterPropertyName AS PropertyName,
[Feb-2018], [Jan-2018], [Dec-2017], [Nov-2017], [Oct-2017], [Sep-2017], [Aug-2017], [Jul-2017], [Jun-2017], [May-2017], [Apr-2017],
[Mar-2017], [Feb-2017], [Jan-2017], [Dec-2016], [Nov-2016], [Oct-2016], [Sep-2016], [Aug-2016], [Jul-2016], [Jun-2016], [May-2016], [Apr-2016]
FROM #TDR T
ORDER BY Flg, MasterPropertyName;
-- TABLE 3 & 4
...
[Mar-2017], [Feb-2017], [Jan-2017], [Dec-2016], [Nov-2016], [Oct-2016], [Sep-2016], [Aug-2016], [Jul-2016], [Jun-2016], [May-2016], [Apr-2016]
FROM #GTVTOTALCLIENT
ORDER BY MarkupFlg, MasterClientName;
...
ROUND(SUM([Dec-2018]) * 0.00001, 0), ROUND(SUM([Jan-2019]) * 0.00001, 0), ROUND(SUM([Feb-2019]) * 0.00001, 0), ROUND(SUM([Mar-2019]) * 0.00001, 0)
FROM #TEMPMONTH16
WHERE MasterClientId IN (SELECT MasterClientId FROM HBAnalysis_ClientList) AND PropertyCategory IN ('External', 'C P P') ;
--
INSERT INTO #TEMPMONTH117
...
ROUND(SUM([Dec-2018]) * 0.00001, 0), ROUND(SUM([Jan-2019]) * 0.00001, 0), ROUND(SUM([Feb-2019]) * 0.00001, 0), ROUND(SUM([Mar-2019]) * 0.00001, 0)
FROM #TEMPMONTH16
WHERE MasterClientId NOT IN (SELECT MasterClientId FROM HBAnalysis_ClientList) AND PropertyCategory IN ('External', 'C P P') ;
/*-- TABLE 3.4
SELECT Title1, Title2,
[Apr-2016], [May-2016], [Jun-2016], [Jul-2016], [Aug-2016], [Sep-2016], [Oct-2016], [Nov-2016], [Dec-2016], [Jan-2017], [Feb-2017], [Mar-2017], 
[Apr-2016] + [May-2016] + [Jun-2016] + [Jul-2016] + [Aug-2016] + [Sep-2016] + [Oct-2016] + [Nov-2016] + [Dec-2016] + [Jan-2017] + [Feb-2017] + [Mar-2017] AS Total,
...
SELECT '' AS C1, 
'Feb-18' AS C2, 'Jan-18' AS C3, 'Dec-17' AS C4, 'Nov-17' AS C5, 'Oct-17' AS C6, 'Sep-17' AS C7, 'Aug-17' AS C8, 'Jul-17' AS C9, 'Jun-17' AS C10, 
'May-17' AS C11, 'Apr-17' AS C12,
'Total' AS Total, 
'Mar-17' AS C13, 'Feb-17' AS C14, 'Jan-17' AS C15, 'Dec-16' AS C16, 'Nov-16' AS C17, 'Oct-16' AS C18, 'Sep-16' AS C19, 'Aug-16' AS C20, 'Jul-16' AS C21, 
'Jun-16' AS C22, 'May-16' AS C23, 'Apr-16' AS C24;
...
CAST(CAST(ROUND((((T1.[Apr-2016] + T1.[May-2016] + T1.[Jun-2016] + T1.[Jul-2016] + T1.[Aug-2016] + T1.[Sep-2016] + T1.[Oct-2016] + 
T1.[Nov-2016] + T1.[Dec-2016] + T1.[Jan-2017] + T1.[Feb-2017] + T1.[Mar-2017]) * 10000) / 
(T2.[Apr-2016] + T2.[May-2016] + T2.[Jun-2016] + T2.[Jul-2016] + T2.[Aug-2016] + T2.[Sep-2016] + T2.[Oct-2016] + 
T2.[Nov-2016] + T2.[Dec-2016] + T2.[Jan-2017] + T2.[Feb-2017] + T2.[Mar-2017])) * 0.01, 0) AS INT) AS VARCHAR)+'%' AS Total,
CAST(CAST(ROUND(((T1.[Mar-2017] * 10000) / T2.[Mar-2017]) * 0.01, 0) AS INT) AS VARCHAR)+'%' AS [Mar-2017],
CAST(CAST(ROUND(((T1.[Feb-2017] * 10000) / T2.[Feb-2017]) * 0.01, 0) AS INT) AS VARCHAR)+'%' AS [Feb-2017],
CAST(CAST(ROUND(((T1.[Jan-2017] * 10000) / T2.[Jan-2017]) * 0.01, 0) AS INT) AS VARCHAR)+'%' AS [Jan-2017],
CAST(CAST(ROUND(((T1.[Dec-2016] * 10000) / T2.[Dec-2016]) * 0.01, 0) AS INT) AS VARCHAR)+'%' AS [Dec-2016],
CAST(CAST(ROUND(((T1.[Nov-2016] * 10000) / T2.[Nov-2016]) * 0.01, 0) AS INT) AS VARCHAR)+'%' AS [Nov-2016],
CAST(CAST(ROUND(((T1.[Oct-2016] * 10000) / T2.[Oct-2016]) * 0.01, 0) AS INT) AS VARCHAR)+'%' AS [Oct-2016],
CAST(CAST(ROUND(((T1.[Sep-2016] * 10000) / T2.[Sep-2016]) * 0.01, 0) AS INT) AS VARCHAR)+'%' AS [Sep-2016],
CAST(CAST(ROUND(((T1.[Aug-2016] * 10000) / T2.[Aug-2016]) * 0.01, 0) AS INT) AS VARCHAR)+'%' AS [Aug-2016],
CAST(CAST(ROUND(((T1.[Jul-2016] * 10000) / T2.[Jul-2016]) * 0.01, 0) AS INT) AS VARCHAR)+'%' AS [Jul-2016],
CAST(CAST(ROUND(((T1.[Jun-2016] * 10000) / T2.[Jun-2016]) * 0.01, 0) AS INT) AS VARCHAR)+'%' AS [Jun-2016], 
CAST(CAST(ROUND(((T1.[May-2016] * 10000) / T2.[May-2016]) * 0.01, 0) AS INT) AS VARCHAR)+'%' AS [May-2016],
CAST(CAST(ROUND(((T1.[Apr-2016] * 10000) / T2.[Apr-2016]) * 0.01, 0) AS INT) AS VARCHAR)+'%' AS [Apr-2016]
