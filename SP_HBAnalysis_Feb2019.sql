...
GO
IF EXISTS (SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID(N'[dbo].[SP_HBAnalysis_Feb2019]') AND OBJECTPROPERTY(ID, N'ISPROCEDURE') = 1)
DROP PROCEDURE [dbo].[SP_HBAnalysis_Feb2019]
GO 
CREATE PROCEDURE [dbo].[SP_HBAnalysis_Feb2019](@Action NVARCHAR(100),@Str NVARCHAR(100),@Id BIGINT)
--Exec [dbo].[SP_HBAnalysis_Feb2019] @Action = '',@Str = '',@Id = 0;
AS
BEGIN
SET NOCOUNT ON
...
SELECT '' AS C1,
'Feb-19' AS C25, 'Jan-19' AS C24, 'Dec-18' AS C23, 'Nov-18' AS C22, 'Oct-18' AS C21, 'Sep-18' AS C2, 'Aug-18' AS C3, 'Jul-18' AS C4, 'Jun-18' AS C5, 'May-18' AS C6, 'Apr-18' AS C7,
...
[Feb-2019], [Jan-2019], [Dec-2018], [Nov-2018], [Oct-2018], [Sep-2018], [Aug-2018], [Jul-2018], [Jun-2018], [May-2018], [Apr-2018],
[Mar-2018], [Feb-2018], [Jan-2018], [Dec-2017], [Nov-2017], [Oct-2017], [Sep-2017], [Aug-2017], [Jul-2017], [Jun-2017], [May-2017], [Apr-2017]
FROM #TDR T
ORDER BY Flg ASC, [Feb-2019] DESC, MasterPropertyName ASC;
-- TABLE 3 & 4
...
[Mar-2018], [Feb-2018], [Jan-2018], [Dec-2017], [Nov-2017], [Oct-2017], [Sep-2017], [Aug-2017], [Jul-2017], [Jun-2017], [May-2017], [Apr-2017]
FROM #TDRClient T
ORDER BY Flg ASC, [Feb-2019] DESC, MasterClientName ASC;
-- TABLE 5 & 6
...
[Mar-2018], [Feb-2018], [Jan-2018], [Dec-2017], [Nov-2017], [Oct-2017], [Sep-2017], [Aug-2017], [Jul-2017], [Jun-2017], [May-2017], [Apr-2017]
FROM #GTVTOTALCLIENT
ORDER BY MarkupFlg ASC, [Feb-2019] DESC, MasterClientName ASC;
...
SELECT '' AS C1,
'Feb-19' AS C29, 'Jan-19' AS C28, 'Dec-18' AS C27, 'Nov-18' AS C26, 'Oct-18' AS C26, 'Sep-18' AS C25, 'Aug-18' AS C24, 'Jul-18' AS C23, 'Jun-18' AS C22, 'May-18' AS C2, 'Apr-18' AS C3,
...
WHERE T.MasterClientId IN (SELECT MasterClientId FROM HBAnalysis_ClientList WHERE Active = 1)
GROUP BY T.MasterClientId, M.ClientName
ORDER BY SUM(ISNULL([Feb-2019],0)) DESC;
--
INSERT INTO #Temp_BookingCnt
